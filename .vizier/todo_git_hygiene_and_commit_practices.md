...
- A Git hygiene guide lives under `docs/` (or equivalent) and describes:
  ...
  - Recommended subject/body conventions for agent-generated commits, including how they reference snapshot threads, TODO artifacts, implementation plans, and architecture docs.

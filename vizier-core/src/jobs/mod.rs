...
fn to_schedule_approval(gates: &[crate::workflow_template::WorkflowGate]) -> Option<JobApproval> {
    for gate in gates {
...
fn workflow_gate_summary(gate: &crate::workflow_template::WorkflowGate) -> String {
    match gate {

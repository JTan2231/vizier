...
- `"$HOME/.config/vizier/workflows/{draft,approve,merge,commit}.hcl"` (or platform equivalent)
- `"$HOME/.config/vizier/develop.hcl"` (or platform equivalent)
...
- `"$DESTDIR$WORKFLOWSDIR/{draft,approve,merge,commit}.hcl"`
- `"$DESTDIR$(dirname "$WORKFLOWSDIR")/develop.hcl"`
